...
class Cborwebtoken {
    ...
    async getTranslatedClaims(payload){
        const translatedClaims = await this.translateClaims(payload)
        const jsonClaims = await this.mapToObj(translatedClaims)
        return JSON.stringify(jsonClaims)
    }
